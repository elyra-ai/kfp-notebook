...
PIP_CONFIG_URL = os.getenv('PIP_CONFIG_URL', 'https://raw.githubusercontent.com/{org}/kfp-notebook/'
                                             '{branch}/etc/pip.conf'.
                                             format(org=KFP_NOTEBOOK_ORG, branch=KFP_NOTEBOOK_BRANCH))
BOOTSTRAP_SCRIPT_URL = os.getenv('BOOTSTRAP_SCRIPT_URL', 'https://raw.githubusercontent.com/{org}/'
                                                         'kfp-notebook/{branch}/etc/docker-scripts/'
                                                         'bootstrapper.py'.
                                                         format(org=KFP_NOTEBOOK_ORG,
                                                                branch=KFP_NOTEBOOK_BRANCH))
REQUIREMENTS_URL = os.getenv('REQUIREMENTS_URL', 'https://raw.githubusercontent.com/{org}/'
...
class NotebookOp(ContainerOp):
    ...
    def __init__(self,
        ...
        if self.emptydir_volume_size:
            ...
            self.python_pip_config_url = PIP_CONFIG_URL
